...
(function (global, factory) {
  ...
  var showWarningNotSupportedInBrowserBundle =
    function showWarningNotSupportedInBrowserBundle(method) {
  ...
  var metaInfoOptionKeys = [
    ...
    defaultInfoKeys[2],
    'changed',
  ].concat(disableOptionKeys); // List of metaInfo property keys which only generates attributes and no tags
  ...
  function removeElementsByAppId(_ref3, appId) {
    ...
    toArray(querySelector('['.concat(attribute, '="').concat(appId, '"]'))).map(
      function (el) {
        return el.remove();
      }
    );
      ...
      beforeCreate: function beforeCreate() {
        ...
        Object.defineProperty(this, '_hasMetaInfo', {
          ...
          get: function get() {
            ...
            if (
              devtoolsEnabled &&
              !$root[rootConfigKey].deprecationWarningShown
            ) {
              warn(
        ...
        if (
          isUndefined($options[options.keyName]) ||
          $options[options.keyName] === null
        ) {
          return;
        }
          ...
          if (!$root[rootConfigKey].initialized) {
            ...
            this.$on('hook:mounted', function () {
              ...
              this.$nextTick(function () {
                ...
                if (
                  tags === false &&
                  $root[rootConfigKey].initialized === null
                ) {
                  this.$nextTick(function () {
                ...
                if (
                  !options.refreshOnceOnNavigation &&
  ...
  function setOptions(options) {
    ...
    return {
      ...
      contentKeyName:
        options['contentKeyName'] || defaultOptions.contentKeyName,
      metaTemplateKeyName:
  ...
  function escape(info, options, escapeOptions, escapeKeys) {
    ...
    for (var key in info) {
      ...
      if (
        ...
        includes(escapeOptions[disableKey], key)
      ) {
  ...
  function _arrayMerge(_ref, target, source) {
    ...
    target.forEach(function (targetItem, targetIndex) {
      ...
      if (
        (contentKeyName in sourceItem &&
          sourceItem[contentKeyName] === undefined) ||
      ...
      if (
        sourceItem[contentKeyName] === null ||
        sourceItem.innerHTML === null
      ) {
